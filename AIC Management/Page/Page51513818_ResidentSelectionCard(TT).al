page 51513818 "Resident Selection Card(TT)"
{
    PageType = Card;
    SourceTable = "Residential Selection Header";
    SourceTableView = sorting () order(ascending) where (Selection = filter ("Technical Training"));
    DeleteAllowed = false;
    ...
    begin
        Selection := Selection::"Technical Training";
    end;

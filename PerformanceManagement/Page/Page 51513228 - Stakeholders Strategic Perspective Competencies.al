page 51513228 "Stakeholders Competencies"
{
    PageType = ListPart;

    SourceTable = "Appraisal Lines";
    SourceTableView = SORTING("No.") WHERE("Strategic Perspective" = CONST(Stakeholder));
    Caption = 'Stakeholder Strategic Perspective Competencies';
    layout
    {
        area(Content)
        {

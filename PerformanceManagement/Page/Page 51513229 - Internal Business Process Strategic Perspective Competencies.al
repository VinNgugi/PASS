page 51513229 "IBP Competencies"
{
    PageType = ListPart;

    SourceTable = "Appraisal Lines";
    SourceTableView = SORTING("No.") WHERE("Strategic Perspective" = CONST("Internal Business Process"));
    Caption = 'Internal Business Processs Perspective Competencies';
    layout
    {
        area(Content)
        {

table 51513921 "Loan Account Entries"
{
    DataClassification = CustomerContent;
    Caption = 'Loan Account Entries';
    DrillDownPageId = "Loan Account Entries";
    LookupPageId = "Loan Account Entries";
    ...
    fields
    {
        ...
        field(31; "Date Imported"; Date)
        {
            DataClassification = CustomerContent;
            caption = 'Date Imported';
        }
        field(32; "Time Imported"; Time)
        {
            DataClassification = CustomerContent;
            caption = 'Time Imported';
        }
        field(33; "Imported By"; Code[20])
        {
            DataClassification = CustomerContent;
            caption = 'Imported By';
            TableRelation = "User Setup";
        }
        field(34; "Risk Sharing Fee"; Decimal)
        {
    ...
    keys
    {
        key(PK; "Loan No", "Reporting Date", "Contract No.")
        {
            Clustered = true;
        }
        key(PK2; "Line No.")

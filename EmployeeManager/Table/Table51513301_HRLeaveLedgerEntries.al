table 51513301 "HR Leave Ledger Entries"
{
    // version HR
    ...
    fields
    {
        ...
        {
            TableRelation = "Leave Recall"."No." WHERE ("Employee No" = FIELD ("Staff No."));
        }
        field(30; "Leave Type"; Code[20])
        {
            TableRelation = "Multi- Comp Leave Types".Code;
        }
        ...
        field(34; "Credited Back"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(35; "Transaction Type"; Option)
        {
            DataClassification = ToBeClassified;

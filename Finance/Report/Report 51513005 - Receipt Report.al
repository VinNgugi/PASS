report 51513005 "Receipt Report"
{
    // version FINANCE

    DefaultLayout = RDLC;
    RDLCLayout = './Layout/Receipts.rdl';
    ...
    dataset
    {
        dataitem("Company Information"; "Company Information")
        {
            ...
            dataitem("Bank Account Ledger Entry"; "Bank Account Ledger Entry")
            {
                ...
                column(Bank_Account_Ledger_Entry__Pay_Mode_; ReceiptHeader."Pay Mode")
                {
                }
                ...
                column(Bank_Account_Ledger_Entry__Cheque_Date_; ReceiptHeader."Cheque Date")
                {
                }
                ...
                column(Bank_Account_Ledger_Entry__Cheque_Date_Caption; ChequeDate)
                {
                }

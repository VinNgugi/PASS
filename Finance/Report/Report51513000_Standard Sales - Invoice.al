report 51513000 "Standard Sales - Invoice 1"
{
    RDLCLayout = './Layout/Standard Sales - Invoice 1.rdl';
    WordLayout = './Layout/Standard Sales - Invoice 1.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(TinNo; CompanyInfo."Company TIN No")
            {
            }
            ...
            column(Tin_Number_Lbl; TinNoLbl)
            {
            }
            ...
            column(CustomerTINNo_Header; Header."Customer TIN")
            {
            }
            column(CustomerVRNNo_Header; Header."Customer VRN")
            {
            }

page 51513881 "Staff Imprest Account Card"
{
    Caption = 'Staff Imprest Account Card';
    PageType = Card;
    ...
    SourceTableView = where ("Customer Posting Group" = filter ('STAFF'));
    ...
    actions
    {
        ...
        area(reporting)
        {
            ...
            action("Report Statement")
            {
                ...
                trigger OnAction()
                begin
                    RunReport(REPORT::"Standard Statement", "No.");
                end;
            }
        }
    }

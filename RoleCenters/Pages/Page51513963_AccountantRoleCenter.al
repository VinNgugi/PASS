page 51513963 "PASS Accountant RC"
{
    ...
    layout
    {
        area(rolecenter)
        {
            group("Documents For Posting")
            {
                part(Activities; "Finance Activities")
                {
                    Caption = 'Activities';
                }
            }
    ...
    actions
    {
        ...
        area(embedding)
        {
            ...
            action(Customers)
            {
                ...
                //RunPageView=where("Customer Posting Group"=const());
        ...
        area(sections)
        {
            group(ActionGroup172)
            {
                ...
                action("Staff Accounts")
                {
                    ...
                    Caption = 'Staff Accounts(Receivables)';
                    Promoted = true;
                    PromotedCategory = Process;
                    RunObject = Page "Customer List";
                    RunPageView = where("Customer Posting Group" = const('STAFF'));
                    ToolTip = 'View or modify Staff receivable Accounts details and related information.';
                }
                action(Action14)
                {
                    ApplicationArea = Basic, Suite;

report 51513535 "Applicants - Top 10 List(Oral)"
{
    // version NAVW111.00

    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ApplicantsTop10List(Oral).rdl';
    ...
    dataset
    {
        dataitem("Job Applicants"; "Job Applicants")
        {
            ...
            begin
                Window.UPDATE(1, "No.");
                CALCFIELDS("Oral Interview Total Score");
                if ("Oral Interview Total Score" = 0) then
                    CurrReport.SKIP;
                AppScore.INIT;
                AppScore."Applicant No." := "No.";
                AppScore.Score := "Oral Interview Total Score";
        ...
        dataitem("Integer"; "Integer")
        {
            ...
            column(ShortlistingTotalScore; "Job Applicants"."Oral Interview Total Score")
            {
                IncludeCaption = true;
            }
            ...
            begin
                ...
                "Job Applicants".CALCFIELDS("Oral Interview Total Score");
                ...
                if StageCode.GET("Job Applicants"."Job ID") then begin
                    ...
                    StageShortlist."Stage Score" := "Job Applicants"."Oral Interview Total Score";
                ...
                "Job Applicants"."Passed Oral Interview" := true;
